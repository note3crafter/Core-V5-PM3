...
use TheNote\core\tile\Dispenser as DispenserTile;

class Dispenser extends Solid implements IRedstone {
    use RedstoneTrait;
    ...
    public function place(Item $item, Block $blockReplace, Block $blockClicked, int $face, Vector3 $clickVector, Player $player = null) : bool {
        ...
        Tile::createTile("Dispenser", $this->getLevel(), DispenserTile::createNBT($this));
        return true;
    }
    ...
    public function onActivate(Item $item, Player $player = null) : bool{
        if($player instanceof Player){
            ...
            if($tile instanceof DispenserTile){
                ...
                $dispenser = Tile::createTile("Dispenser", $this->getLevel(), DispenserTile::createNBT($this));
            }
    ...
    public function getBlockEntity() : DispenserTile {
        $tile = $this->getLevel()->getTile($this);
        $dispenser = null;
        if($tile instanceof DispenserTile){
            $dispenser = $tile;
