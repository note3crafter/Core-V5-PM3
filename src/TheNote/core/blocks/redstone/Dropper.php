...
use TheNote\core\tile\Dropper as DropperTile;

class Dropper extends Solid implements IRedstone {
    use RedstoneTrait;
    ...
    public function place(Item $item, Block $blockReplace, Block $blockClicked, int $face, Vector3 $clickVector, Player $player = null) : bool {
        ...
        Tile::createTile("Dropper", $this->getLevel(), DropperTile::createNBT($this->asVector3()));
        return true;
    }
    ...
    public function onActivate(Item $item, Player $player = null) : bool{
        if($player instanceof Player){
            ...
            if($tile instanceof DropperTile){
                ...
                $dropper = Tile::createTile("Dropper", $this->getLevel(), DropperTile::createNBT($this));
            }
    ...
    public function getBlockEntity() : DropperTile {
        $tile = $this->getLevel()->getTile($this);
        $dropper = null;
        if($tile instanceof DropperTile){
            $dropper = $tile;
