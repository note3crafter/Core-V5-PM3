...
namespace TheNote\core\blocks\redstone\commandblock;
...
use TheNote\core\tile\CommandBlock as CommandBlockTile;
use TheNote\core\blocks\redstone\IRedstone;
use TheNote\core\blocks\redstone\RedstoneTrait;

class CommandBlock extends Solid implements IRedstone {
    use RedstoneTrait;
    ...
    public function place(Item $item, Block $blockReplace, Block $blockClicked, int $face, Vector3 $clickVector, Player $player = null) : bool {
        ...
        Tile::createTile("CommandBlock", $this->getLevel(), CommandBlockTile::createNBT($this->asVector3()));
        return true;
    }
    ...
    public function getBlockEntity() : CommandBlockTile {
        $tile = $this->getLevel()->getTile($this);
        $command = null;
        if($tile instanceof CommandBlockTile){
            $command = $tile;
        }else{
            $command = Tile::createTile("CommandBlock", $this->getLevel(), CommandBlockTile::createNBT($this));
        }
        return $command;
    }
