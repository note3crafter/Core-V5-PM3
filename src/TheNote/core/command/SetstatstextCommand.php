...
class SetstatstextCommand extends Command
{
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args): bool
    {
        ...
        $cfg->set("level", $cfg->get("level") . $sender->getLevel()->getFolderName());
        $cfg->set("X", $cfg->get("level") . $sender->getX());
        $cfg->set("Y", $cfg->get("level") . $sender->getY());
        $cfg->set("Z", $cfg->get("level") . $sender->getZ());
